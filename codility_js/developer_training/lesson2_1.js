 ...
 * shifted right by one index, and the last element of the array is also moved to the first place. For
 ...
 * 
 * that, given an array A consisting of N integers and an integer K, returns the array A after rotation
 * K times.
 * 
 * For example, given
 *  A = [3, 8, 9, 7, 6]
...
function solution(A, K) {
  ...
  let rotatedArray = structuredClone(A); // Use structuredClone to avoid mutating the original array
